    ...
    <div className="text-gray-900 text-sm">
      <nav className="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4 text-white">
          ...
          <a href="#" className="flex items-center hover:text-gray-400">
            <img
              src="https://avatars.githubusercontent.com/u/9403469?v=4"
              alt="avatar"
              size="32"
              height="32"
              width="32"
      ...
      <div className="repo-stats flex items-center justify-between px-8 py-4">
        ...
        <div className="flex space-x-2">
          <div className="flex text-xs">
            ...
            <a
              href="#"
              className="border border-gray-400 rounded rounded-l-none border-l-0 font-semibold hover:text-blue-600 px-3 py-1"
            >
              430
            </a>
          </div>
      ...
      <ul className="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
        ...
        <li>
          <a
            href="#"
            className="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3"
          >
            <svg
              aria-hidden="true"
              height="16"
        ...
        <li>
          ...
          >
            ...
            <div className="text-xs rounded-lg bg-gray-300 px-2 ml-1">14</div>
          </a>
        </li>
        <li>
          <a
